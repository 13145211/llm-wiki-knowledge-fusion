...
- **Prompt 轮换**：5 种角色变体（博士后 / 资深科学家 / 博士生 / 期刊审稿人 / 工业研发）自动轮换
...
产出 7 段结构化笔记：**基本信息 / 研究背景 / 方法路线 / 核心结果 / 创新点 / 局限展望 / 原文摘要**，并附图表定量读取协议（XRD、TEM、H₂-TPR、XPS、活性曲线、Arrhenius、表格）与 5 项自检清单（数字反查、措辞合规、图表全覆盖、引号溯源、零占位符）。

默认面向催化领域文献，**可在面板 Prompt 编辑框中改成任意学科**。
